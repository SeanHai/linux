...
__attribute__((section("__versions"))) = {
	...
	{ 0x92f147b4, "rt5645_set_jack_detect" },
	...
	{ 0xc5de97d2, "rt5645_sel_asrc_clk_src" },
...
"depends=snd-soc-core,snd-soc-rt5645,snd-pcm,snd-soc-acpi";


MODULE_INFO(srcversion, "DF196B90213F148B5E34ABC");
